...
def process(model, in_wav_path, out_wav_path, out_input=False):
    try:
...
def main():
    ...
    add_window, out_input = "none", False
    in_pt_path = "../data/models/drb_only/DTLN_0827_wSDR_drb_only_rts_0.05_tam_0.05_none_ep66.pth"
