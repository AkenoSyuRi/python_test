...
def get_gruc_network(in_pt_path, win_len, win_inc, fft_len, hidden_layers, hidden_units):
...
def export_ncnn_by_pnnx(out_pt_path, net, *inputs):
    ...
    cmd1 = f'{pnnx_exe} {out_pt_path} inputshape={get_shapes(*inputs)}'
    print(cmd1)
    os.system(cmd1)
    ...
...
def export_ncnn():
    ...
    in_pt_path = "../data/models/GRUC/GRUC_0813_wSDR_drb_only_pre100ms_ep66.pth"
